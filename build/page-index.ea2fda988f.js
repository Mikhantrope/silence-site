...
on(g, 'resize', queuePosition, { passive: true });
on(g, 'scroll', queuePosition, { passive: true });
if (g.visualViewport) {
...
ro.disconnect(); g.cancelAnimationFrame(positionFrame); g.clearTimeout(focusTimer); };
